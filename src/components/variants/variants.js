export const variants = [
  ...
  },
  {
    name: "19B",
    description: `
    Another variant with S:S477N arose independently in Australia (Nextstrain Clade 20F) and was responsible for much of the Jun-Oct 2020 outbreak (Nextstrain build ).
  ...
  },
  {
    name: "20B",
    description: `
    20B is found primarily in Sweden and northern European countries, including Norway and Denmark.
    `,
  },
  {
    name: "20C",
    description: `
    20C was first identified in California and appears to have increased in frequency (Zhang et al., JAMA ).
  ...
  },
  {
    name: "20D",
    description: `
    20D is largely found within the USA, particularly in New York state, and seems to have arisen in late 2020.
